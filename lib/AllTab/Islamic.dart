...
class _IslamicState extends State<Islamic> {
  ...
  Future<void> FatchYoutubeVideo() async {
    ...
    final String apiUrl =
        'https://www.googleapis.com/youtube/v3/search?part=snippet&q=${Uri.encodeComponent("bangla hindi arabic islamic gojol and video")}&maxResults=50&regionCode=BD&relevanceLanguage=bn&key=${Api_Url.myApi}';
