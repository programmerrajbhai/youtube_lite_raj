...
class _MotivationState extends State<Motivation> {
  ...
  Future<void> FatchYoutubeVideo() async {
    ...
    final String apiUrl =
        'https://www.googleapis.com/youtube/v3/search?part=snippet&q=${Uri.encodeComponent("motivational video bangla english")}&maxResults=50&regionCode=BD&relevanceLanguage=bn&key=${Api_Url.myApi}';
