...
class Songmovie extends StatefulWidget {
  const Songmovie({super.key});

  @override
  State<Songmovie> createState() => _SongmovieState();
}

class _SongmovieState extends State<Songmovie> {
  ...
  Future<void> FatchYoutubeVideo() async {
    ...
    final String apiUrl =
        'https://www.googleapis.com/youtube/v3/search?part=snippet&q=${Uri.encodeComponent("bangla english hindi movie and song")}&maxResults=50&regionCode=BD&relevanceLanguage=bn&key=${Api_Url.myApi}';
