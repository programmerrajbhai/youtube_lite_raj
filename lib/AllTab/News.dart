...
class _NewsState extends State<News> {
  ...
  Future<void> FatchYoutubeVideo() async {
    ...
    final String apiUrl =
        'https://www.googleapis.com/youtube/v3/search?part=snippet&q=${Uri.encodeComponent("News Politics Education Science & Technology Health & Medicine Entertainment Politics Economy & Business")}&maxResults=50&regionCode=BD&relevanceLanguage=bn&key=${Api_Url.myApi}';
